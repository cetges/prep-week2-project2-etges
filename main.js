...
a1.unshift("yo");
document.getElementById("q2").innerHTML = a1;
...
a1.splice(1, 2)
document.getElementById("q3").innerHTML = a1;
...
a1.splice(2, 0, "guten tag", "bonjourno")
document.getElementById("q4").innerHTML = a1;
...
console.log("The current length of the array is " + a1.length);
document.getElementById("q5").innerHTML = ("The current length of the array is " + a1.length);
...
var deskThings = things.join();
document.getElementById("q7").innerHTML = deskThings;
...
var reversedItems = [lastItem.sort(function(a, b) {
    return b - a
})];
